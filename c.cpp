...
doubly_linked_list array_to_linked_list(student* students,int n)
{
...
student* linked_list_to_array(doubly_linked_list& list,int n)
{
    node* temp= list.head;
...
void print_linked_list(doubly_linked_list& list)
{
...
int main()
{
    ...
    doubly_linked_list list=array_to_linked_list(students,n);
