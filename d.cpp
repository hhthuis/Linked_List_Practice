...
circular_linked_list array_to_linked_list(student* students,int n)
{
...
student* linked_list_to_array(circular_linked_list& list,int n)
{
    node* temp= list.head;
...
void print_linked_list(circular_linked_list& list)
{
...
int main()
{
    ...
    circular_linked_list list=array_to_linked_list(students,n);
